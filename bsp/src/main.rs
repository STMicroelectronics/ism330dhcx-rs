...
mod mode {
    ...
    pub use ism330dhcx_rs::asynchronous as ism330dhcx;
...
mod mode {
    ...
    pub use ism330dhcx_rs::blocking as ism330dhcx;
    pub use cortex_m_rt::interrupt;
}

pub use mode::*;
pub use ism330dhcx::I2CAddress;
...
// ── Example definitions ─────────────────────────────────────────────────────────
// Fsm free-fall
#[cfg(feature = "fsm_free_fall")]
mod examples {
    mod fsm_free_fall;
    pub use fsm_free_fall::run;
}
...
// MLC Six-d position detection
#[cfg(feature = "mlc_six_d")]
mod examples {
    mod mlc_six_d;
    pub use mlc_six_d::run;
}
...
// Sensor-hub IIS2MDC using FIFO
#[cfg(feature = "sensor_hub_fifo")]
mod examples {
    mod sensor_hub_fifo;
    pub use sensor_hub_fifo::run;
}

// ─── Compilation checks ──────────────────────────────────────────
#[cfg(not(any(
    feature = "fsm_free_fall",
    feature = "mlc_six_d",
    feature = "read_polling",
    feature = "self_test",
    feature = "sensor_hub",
    feature = "sensor_hub_fifo",
)))]
